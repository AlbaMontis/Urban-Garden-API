...
function getSharp() {
  ...
  sharp.concurrency((0, _gatsbyCoreUtils.cpuCoreCount)());
  return sharp;
}
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return _context4.abrupt("return", getSharp()(srcIcon, {
              density: density
            }).resize({
              width: size,
              height: size,
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            localize = _ref2.localize, manifest = (0, _objectWithoutPropertiesLoose2.default)(_ref2, _excluded);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            icon = pluginOptions.icon, manifest = (0, _objectWithoutPropertiesLoose2.default)(pluginOptions, _excluded2);
