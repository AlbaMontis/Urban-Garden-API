import*as React from"react";import{useStaticQuery,graphql}from"gatsby";import{withPathPrefix}from"../utils";export function useAPICatalog(){const{apis:a,siteConfig:{withRbac:b},site:{pathPrefix:c}}=useStaticQuery(graphql`
    {
      siteConfig {
        withRbac
      }
