...
export { useAPICatalog, APICatalog } from './legacy-catalog';
export { useCatalog } from './catalog';
export type { APICatalogItem } from './legacy-catalog';
export type { ApiCatalogApi, ApiCatalogApiVersion } from './catalog';
