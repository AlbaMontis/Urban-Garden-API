import{normalize,getLuminance}from"polished";import{createGlobalStyle,css}from"styled-components";import{appTheme,genTokens}from"./appTheme";const codeBlockBackgroundColor=Array.isArray(appTheme.codeBlock.backgroundColor)?appTheme.codeBlock.backgroundColor[0]:appTheme.codeBlock.backgroundColor,lightStyleCodeButton=css`
  .gatsby-code-button,
  .done-indicator {
...
`;export const GlobalStyle=createGlobalStyle`
  ...
  body {
    height: 100%;
    font-size: ${appTheme.typography.fontSize};
 ...
 .gatsby-highlight pre[class*='language-'],
  ...
  pre[class*='language-'] {
    ...
    overflow: auto;
    border: 0;
    border-radius: ${appTheme.shape.borderRadius};
  }
