 ...
 */
export function initDefinitionsWithPageYamlCache({ configPath, getSiteConfig }: PluginOptions, reporter: import("gatsby-cli/lib/reporter/reporter").Reporter): Promise<void>;
export function hasCorrespondingPageYaml(oasAbsolutePath: any): boolean;
